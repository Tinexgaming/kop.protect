...
bot.on('ready', () => {
	...
	let status = ["Protèger" +client.guilds.size+" serveurs ", client.users.size +"utilisateurs en sécurité", "Créer par Tinex le Clinex {Ping = 🎄}", "Merci ", "kp/help pour voir ma page d'aide"]
  ...
  message.channel.send(embed)
    ...
    if(message.content === prefix + "invite") {
      ...
      if(message.content === prefix + "aide.admin") {
